    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center"
                ...
                <div class="sidebar-brand-text mx-2">Zepyhr Store</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('kategori/pakaian_laki_laki')?>">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('kategori/sepatu_laki_laki')?>">
                    <i class="fas fa-shoe-prints"></i>
                    <span>Sepatu Laki - Laki</span></a>
            </li>
