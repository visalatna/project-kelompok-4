<div class="container-fluid">
    <button class="btn btn-sm btn-success mb-3" data-toggle="modal" data-target="#tambah_barang">
        <i class="fas fa-plus fa-sm"></i> Tambahkan Barang </button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">FORM MENAMBAHKAN PRODUK BARANG</h5>
        ...
        method="post"enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="kategori">
                    ...
                    <option>Pakaian Laki - Laki</option>
                    <option>Pakaian Wanita</option>
                    <option>Pakaian anak - anak</option>
                    <option>Sepatu Laki - Laki</option>
